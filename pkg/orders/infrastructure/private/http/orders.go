...
import (
	...
	common_http "github.com/aleqxan/monolith-microservice/pkg/common/http"
	"github.com/aleqxan/monolith-microservice/pkg/orders/application"
	"github.com/aleqxan/monolith-microservice/pkg/orders/domain/orders"
...
func (o ordersResource) PostPaid(w http.ResponseWriter, r *http.Request) {
	cmd := application.MarkOrderAsPaid{
